    ...
    const { model } = await inquirer.prompt([
      {
        ...
        choices: [
          { name: 'Claude Sonnet 4 (빠르고 경제적, 권장)', value: 'claude-sonnet-4-20250514' },
          { name: 'Claude Opus 4 (최고 품질, 비용 높음)', value: 'claude-opus-4-20250514' },
          { name: 'Claude Haiku 3.5 (가장 빠르고 저렴)', value: 'claude-haiku-4-5-20251001' },
        ],
      },
    ]);
    config.model = model;
