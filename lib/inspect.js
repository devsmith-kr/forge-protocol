...
export async function runInspect() {
  ...
  // inspect-prompt.md (AI에 붙여넣기용)
  const inspectPrompt = buildInspectPrompt(
    blocks, techStack, detectedFeatures, contracts,
    selectedFindings, checklistByPerspective, perspectives, reportLevel
  );
  await writeFile(
...
function buildInspectPrompt(blocks, techStack, detectedFeatures, contracts, findings, checklist, perspectives, level) {
